/*!
 * ToolAspect Dog Crate Size for a French Bulldog Embed
 * Install: <div id="ta-dog-crate-size-for-french-bulldog"></div>
 *          <script src="https://toolaspect.com/embed/dog-crate-size-for-french-bulldog.js"></script>
 * Options: add data-theme="dark" to the container div for dark theme.
 */
(function () {
  'use strict';
  var TARGET_ID = 'ta-dog-crate-size-for-french-bulldog';
  var BASE = 'https://toolaspect.com/dog-crate-size-for-french-bulldog/';
  ...
  styleEl.setAttribute('data-ta-embed', 'dog-crate-size-for-french-bulldog');
  styleEl.textContent = CSS;
  if (!document.querySelector('style[data-ta-embed="dog-crate-size-for-french-bulldog"]')) {
  ...
  root.innerHTML = ''
    + '<div class="ta-embed-title">Dog Crate Size for a French Bulldog</div>'
    + '<div class="ta-embed-subtitle">French Bulldog crate sizing — 24", or 30" for broad chests</div>'
    + '<div class="ta-embed-card">'
    + '<div class="ta-embed-form-row">'
    + '<div class="ta-embed-form-group"><label>Body length (in)</label><input type="number" class="ta-len" value="19" min="6" max="60" step="0.5"></div>'
    + '<div class="ta-embed-form-group"><label>Standing height (in)</label><input type="number" class="ta-hgt" value="16" min="6" max="44" step="0.5"></div>'
    + '<div class="ta-embed-form-group"><label>Weight (lb)</label><input type="number" class="ta-wt" value="25" min="2" max="250" step="1"></div>'
    + '</div>'
  ...
  window.ToolAspectEmbeds.dogCrateSizeForFrenchBulldog = { recalc: calc };
})();
