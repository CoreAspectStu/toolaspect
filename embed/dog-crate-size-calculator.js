/*!
 * ToolAspect Dog Crate Size Calculator Embed
 * Install: <div id="ta-dog-crate-size-calculator"></div>
 *          <script src="https://toolaspect.com/embed/dog-crate-size-calculator.js"></script>
 * Options: add data-theme="dark" to the container div for dark theme.
 */
(function () {
  'use strict';
  var TARGET_ID = 'ta-dog-crate-size-calculator';
  var BASE = 'https://toolaspect.com/dog-crate-size-calculator/';
  ...
  styleEl.setAttribute('data-ta-embed', 'dog-crate-size-calculator');
  styleEl.textContent = CSS;
  if (!document.querySelector('style[data-ta-embed="dog-crate-size-calculator"]')) {
  ...
  root.innerHTML = ''
    + '<div class="ta-embed-title">Dog Crate Size Calculator</div>'
    + '<div class="ta-embed-subtitle">Length + 2–4" to the right crate size</div>'
  ...
  window.ToolAspectEmbeds.dogCrateSizeCalculator = { recalc: calc };
})();
