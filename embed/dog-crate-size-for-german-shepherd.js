/*!
 * ToolAspect Dog Crate Size for a German Shepherd Embed
 * Install: <div id="ta-dog-crate-size-for-german-shepherd"></div>
 *          <script src="https://toolaspect.com/embed/dog-crate-size-for-german-shepherd.js"></script>
 * Options: add data-theme="dark" to the container div for dark theme.
 */
(function () {
  'use strict';
  var TARGET_ID = 'ta-dog-crate-size-for-german-shepherd';
  var BASE = 'https://toolaspect.com/dog-crate-size-for-german-shepherd/';
  ...
  styleEl.setAttribute('data-ta-embed', 'dog-crate-size-for-german-shepherd');
  styleEl.textContent = CSS;
  if (!document.querySelector('style[data-ta-embed="dog-crate-size-for-german-shepherd"]')) {
  ...
  root.innerHTML = ''
    + '<div class="ta-embed-title">Dog Crate Size for a German Shepherd</div>'
    + '<div class="ta-embed-subtitle">German Shepherd crate sizing — 42" for most adults</div>'
    + '<div class="ta-embed-card">'
    + '<div class="ta-embed-form-row">'
    + '<div class="ta-embed-form-group"><label>Body length (in)</label><input type="number" class="ta-len" value="33" min="6" max="60" step="0.5"></div>'
    + '<div class="ta-embed-form-group"><label>Standing height (in)</label><input type="number" class="ta-hgt" value="25" min="6" max="44" step="0.5"></div>'
    + '<div class="ta-embed-form-group"><label>Weight (lb)</label><input type="number" class="ta-wt" value="75" min="2" max="250" step="1"></div>'
    + '</div>'
  ...
  window.ToolAspectEmbeds.dogCrateSizeForGermanShepherd = { recalc: calc };
})();
