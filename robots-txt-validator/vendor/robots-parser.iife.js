/*!
 * robots-parser 3.0.1 — https://github.com/samclarke/robots-parser
 * MIT License, Copyright (c) Sam Clarke — bundled unmodified (index.js + Robots.js)
 * into a single IIFE exposing window.robotsParser by ToolAspect.
 */
(function (root, factory) {
  if (typeof define === 'function' && define.amd) define([], factory);
  else if (typeof module === 'object' && module.exports) module.exports = factory();
  else root.robotsParser = factory();
...
module.exports = Robots;
  ...
  var Robots = __m.exports;
  return function (url, contents) { return new Robots(url, contents); };
}));
