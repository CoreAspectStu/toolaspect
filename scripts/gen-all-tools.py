...
def cat_of(slug):
    ...
    for k, c in [
        ...
        (("wedding","party","baby","pet","gift","anniversary","vacation","trip","travel","holiday","christmas","halloween","countdown","tdee","gpa","grade","study","homework","college","529","student","exam","sat","act","name-change"),"Life & Education"),
        (("auto","car","tire","mpg","fuel","gas","ev","hybrid","engine","vehicle","dealer","vin","lift-kit"),"Auto"),
