  ...
  var categories = [
    {
      ...
      tools: [
        ...
        { label: 'MarriageGreenCardCost', href: '/marriage-green-card-cost-calculator/' },
        { label: 'MarriageNameChangeCost', href: '/marriage-name-change-cost-calculator/' },
  ...
  /* ---- Categories added 2026-08-28 to cover full tool inventory ---- */
    {
      ...
      tools: [
        ...
        { label: 'PatreonFees', href: '/patreon-fees-calculator/', badge: 'New' },
        ...
        { label: 'Boosty', href: '/boosty/' },
        { label: 'RumbleEarnings', href: '/rumble-earnings/' },
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'VideoWatermark', href: '/video-watermark/' },
        ...
        { label: 'CopyrightDamages', href: '/copyright-infringement-damages/' },
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'LiftKitCost', href: '/lift-kit-cost-calculator/' },
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'LLCvsScorp', href: '/llc-vs-scorp-calculator/' },
        ...
        { label: 'VA Disability Pay', href: '/va-disability-pay-calculator/' },
        { label: 'VABackPay', href: '/va-disability-backpay-calculator/' },
        { label: 'TDIU', href: '/tdiu-calculator/' },
        { label: 'VAPensionAidAttendance', href: '/va-pension-aid-and-attendance-calculator/' },
